...
function isDefinedBoolean(arg) {
  return (  (typeof arg !== 'undefined')
         && (typeof arg === 'boolean'));
}


function isDefinedNonBoolean(arg) {
  return (  (typeof arg !== 'undefined')
         && (typeof arg !== 'boolean'));
}
...
function checkSocketAddress(socketAddress) {
  ...
  if (!validator.isIP(socketAddress.ip)) {
    throw new Error('Parameter \'socketAddress.ip: ' + socketAddress.ip + '\' is an invalid IP-address');
  }
...
module.exports.isDefinedBoolean     = isDefinedBoolean;
module.exports.isDefinedNonBoolean  = isDefinedNonBoolean;
